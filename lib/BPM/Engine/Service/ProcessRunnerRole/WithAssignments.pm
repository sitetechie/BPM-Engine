...
package BPM::Engine::Service::ProcessRunnerRole::WithAssignments;
BEGIN {
    $BPM::Engine::Service::ProcessRunnerRole::WithAssignments::VERSION   = '0.001';
    $BPM::Engine::Service::ProcessRunnerRole::WithAssignments::AUTHORITY = 'cpan:SITETECH';
    }
